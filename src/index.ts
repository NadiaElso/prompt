...
//let stockleche:number=Number(prompt("stock disponible de leche"));

let precioleche:number=Number(prompt("Precio Leche"));


let stockazucar:number=Number(prompt("Stock disponible de azucar"));

let precioazucar:number=Number(prompt("Precio Azucar"));

let stockfideo:number=Number(prompt("Stock de fideo"));

let preciofideo:number=Number(prompt("Precio de Fideo"));


console.log( stockLeche);
console.log(precioLeche);
console.log(stockAzucar);
console.log(precioazucar);
console.log(stockfideo);
console.log(preciofideo);